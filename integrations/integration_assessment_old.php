...
h5{
    font-family: "Times New Roman", Times, serif; color: blue; font-style: italic; font-size: 10; margin-bottom: 5px;
}
...
<div class="form-section">
    ...
    <div class="section-body">
        ...
        <div class="form-group">
            ...
            <h5>(Select the Health Facility Name using Facility Name or MFL Code/MFL code is faster)</h5>
        ...
        <div class="form-grid" style="margin-top:18px">
            <div class="form-group">
                ...
                <h5>Indicate Yes if the is supported by US DoS IP or No if not</h5>
                <div class="yn-group">
            ...
            <div class="form-group">
                ...
                <h5>Indicate if the health facility is an ART site or No if not</h5>
                <div class="yn-group">
...
<div class="form-section">
    ...
    <div class="section-body">
        <div class="form-group">
            ...
            <h5>Please select YES, if the health facility has Integrated HIV/TB services within OPD or clinical care model,or NO if it has not.</h5>
            <div class="yn-group">
        ...
        <div class="form-group">
            ...
            <p style="margin-left: 10px; color: blue">Please select the integration model types i.e., OPD, Chronic Care Center.</p>
            <p style="margin-left: 10px; color: blue">The integration models are based on the  national blue print and integration advisory memo.</p>
            <p style="margin-left: 10px; color: blue">It includes the following models and their descriptions.</p>
            <p style="margin-left: 10px; color: blue"><b>OPD</b> - HIV and TB services integrated in OPDp</p>
            <p style="margin-left: 10px; color: blue"><b>Chronic Care Center</b> - This model refers to HIV/ TB services provided in the chronic care centers</p>
        ...
        <div class="form-grid-3">
            <div class="form-group">
                ...
                <h5>Indicate the Current on Treatment reported in the last month to the baseline</h5>
            ...
            <div class="form-group">
                ...
                <h5>Indicate the Current on Treatment for PMTCT reported in the last month to the baseline</h5>
            ...
            <div class="form-group">
                ...
                <h5>Indicate the total number of PLHIVs receiving HIV/TB care through integrated service models from the health facility that has integrated HIV/TB services.</h5>
...
<div class="form-section">
    ...
    <?php
    $q2b = [
        ['Q14', 'pmtct_integrated_mnch', 'Has the facility integrated PMTCT services in MNCH?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility has integrated PMTCT services in MNCH, or NO if not, or Not Applicable</span>'],

        ['Q15', 'hts_integrated_opd', 'Has the facility integrated HTS services in OPD?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility has integrated HTS services in OPD, or NO if not, or Not Applicable</span>'],

        ['Q16', 'hts_integrated_ipd', 'Has the facility integrated HTS services in IPD?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility has integrated HTS services in IPD, or NO if not, or Not Applicable</span>'],

        ['Q17', 'hts_integrated_mnch', 'Has the facility integrated HTS services in MNCH?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility has integrated HTS services in MNCH, or NO if not, or Not Applicable</span>'],

        ['Q18', 'prep_integrated_opd', 'Has the facility integrated PrEP services in OPD?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility integrated HIV Prevention services (HTS & PrEP) in OPD, or NO if not, or Not Applicable</span>'],

        ['Q19', 'prep_integrated_ipd', 'Has the facility integrated PrEP services in IPD?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility integrated HIV Prevention services (HTS & PrEP) in IPD, or NO if not, or Not Applicable</span>'],

        ['Q20', 'prep_integrated_mnch', 'Has the facility integrated PrEP services in MNCH?', '<span style="color: blue; font-size: 12px;">Select YES if the health facility integrated HIV Prevention services (HTS & PrEP) in MNCH, or NO if not, or Not Applicable</span>'],
    ];
    ?>

    <div class="form-grid">
    <?php foreach ($q2b as [$qn, $fn, $ql, $hint]): ?>
        <div class="form-group">
            <label><?= $qn ?>. <?= $ql ?></label>
            ...
            <div class="yn-group">
                ...
                <label class="yn-opt"><input type="radio" name="<?= $fn ?>" value="NA"> N/A</label>
            </div>
        </div>
    <?php endforeach; ?>
    </div>
    ...
    <div class="section-body">
        <div class="form-grid">
            <div class="form-group">
                ...
                <h5>Select YES if the health facility is using any EMR system or NO if not</h5>
                <div class="yn-group">
            ...
            <div class="form-group">
                ...
                <h5>Select YES if the health facility has a single unified EMR system, or NO if the facility doesn’t have.</h5>
                <div class="yn-group">
