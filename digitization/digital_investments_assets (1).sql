...
--
-- Host: localhost:3306
-- Generation Time: May 01, 2026 at 10:39 PM
...
CREATE TABLE `digital_investments_assets` (
  ...
  `dit_asset_name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'e.g. Desktop Computer, Router, Smartphone',
  `depreciation_percentage` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT 'Annual reducing-balance rate  (0–100)',
  `asset_category` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Optional grouping (Hardware, Network, etc.)',
  `description` text COLLATE utf8mb4_general_ci,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Catalogue of digital asset types with depreciation rates';
